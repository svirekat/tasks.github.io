...
def FletcherReeves(x_start):
    ...
    while True:
        ...
        if k == 0:
            ...
            norm_gr_pred = norm(gradient_f(x_pred[0], x_pred[1]))
            beta = norm_gr**2 / norm_gr_pred**2
            beta_d_pred = [beta*d_pred[0], beta*d_pred[1]]
            d = minus(beta_d_pred, gr)
        ...
        d_pred = d
        k += 1
print(f'\nпоиск минимума методом Флетчера-Ривса')
ans = FletcherReeves(x0)
